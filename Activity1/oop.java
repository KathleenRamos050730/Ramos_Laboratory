...
class BankAccount {
    ...
    public BankAccount(String accountHolderName, double initialBalance) {
        ...
        this.balance = initialBalance; // ang behavior ay this
    }

    //Encapsulation: Getter and Setter Methods
    public String getAccountHolderName(){// public means we can access these methods sa mga child class
...
class SavingsAccount extends BankAccount {
    private double interestRate; // private we cannot use the method sa ibang part ng classes
    
    //Constructor
    public SavingsAccount(String accountHolderName, double initialBalance, double interestRate){
        super(accountHolderName, initialBalance); //tinatawag ang super class instructor
...
class CurrentAccount extends BankAccount {
    ...
    //Overriding withdraw method to allow method to overdraft
    @Override
    public void withdraw(double amount) {
